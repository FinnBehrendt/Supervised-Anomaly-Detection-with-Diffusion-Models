...
from src.models.modules.DRAEM.utils import random_2d_perlin
...
class Augmenter:
    ...
    def augment_batch(self, batch: Tensor,mask=None) -> tuple[Tensor, Tensor]:
        ...
        for _ in range(batch_size):
            if torch.rand(1) > self.p_anomalous:  # include normal samples
                ...
                perturbations_list.append(Tensor(perturbation).permute((2, 0, 1))) if channels == 3 else perturbations_list.append(Tensor(perturbation[...,0]).unsqueeze(0))
